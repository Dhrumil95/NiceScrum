<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="invalidCred.aspx.cs" Inherits="NiceScrum.invalidCred" %>
...
<head runat="server">
   ...
   #Button1:hover {background-color: rgba(76, 175, 80, 1.00)}
   ...
   #Button2 {
    ...
    #Button2:hover {background-color: rgba(128, 128, 128, 0.75)}
    #Button2:active {
